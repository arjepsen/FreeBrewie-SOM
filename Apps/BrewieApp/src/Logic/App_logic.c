...
void app_logic_update(app_logic_t *logic, const comms_status_t *comms_status, uint64_t now_ms)
{
    ...
    else
    {
        ...
        logic->status_screen.last_rx_text = last_rx_text;
    }
    ...
    if (mcu_status->valid)
    {
        ...
        logic->status_screen.mcu_status_text = mcu_status_text;
        ...
        logic->status_screen.pressure_text = pressure_text;
        ...
        logic->status_screen.pump_text = pump_text;
        ...
        logic->status_screen.solenoid_text = solenoid_text;
        ...
        if (mcu_status->fault_flags != 0U)
        {
            ...
            logic->status_screen.fault_text = fault_text;
        }
        else
        {
