...
typedef enum
{
    ...
    UI_SCREEN_RECIPE_BUILDER,
    UI_SCREEN_RECIPE_DRAFT_BREWING,
    UI_SCREEN_RECIPE_DRAFT_DETAILS,
    UI_SCREEN_RECIPE_DRAFT_INGREDIENTS,
    UI_SCREEN_RECIPE_DRAFT_MENU,
    UI_SCREEN_RECIPE_SECTION,
    UI_SCREEN_BREW_SETUP,
    UI_SCREEN_BREW_CHECKLIST,
    UI_SCREEN_ACTIVE_BREWING,
    UI_SCREEN_MANUAL,
    UI_SCREEN_SETTINGS,
    UI_SCREEN_FAULT
} ui_screen_id_t;
...
typedef enum
{
    ...
    UI_ACTION_SHOW_BREW_SETUP,
    UI_ACTION_SHOW_BREW_CHECKLIST,
    UI_ACTION_SHOW_ACTIVE_BREWING,
